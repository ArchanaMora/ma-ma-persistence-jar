...
public class UserCache implements Serializable
{
	...
	{
		return "UserCache [id=" + id + ", cacheKey=" + cacheKey + ", cacheType=" + cacheType + ", cacheValue=" + cacheValue + ", createdBy=" + createdBy
				+ ", createdDate=" + createdDate + ", expireDuration=" + expireDuration + ", expiresOn=" + expiresOn + ", hitCount=" + hitCount
				+ ", lastAccessTime=" + lastAccessTime + ", updatedBy=" + updatedBy + ", updatedDate=" + updatedDate + ", userKey=" + userKey + "]";
	}
