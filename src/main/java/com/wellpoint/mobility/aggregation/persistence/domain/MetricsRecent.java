...
/**
 * The persistent class for the METRICS_RECENT database table.
 * 
 */
@Entity

@NamedQueries({
    @NamedQuery(name = "MetricsRecent.get.by.tsDateTime", 
    	query="SELECT e FROM MetricsRecent e where e.tsDateTime < :queryValue"
    )
}) 

@Table(name = "METRICS_RECENT")
public class MetricsRecent implements Serializable
{
	...
	{
		return "MetricsRecent [id=" + id + ", applicationName=" + applicationName + ", className=" + className + ", componentName=" + componentName
